...
# add legend
legend("topright", legend = nlabs, col = cols, lty = ltypes, bty = 'n')
#### WARNING: using diplay instead png device, additional parameters should be adjusted
#### following legend code can be used for display use
# legend("topright", legend = nlabs, col = cols, lty = ltypes,
#        bty = 'n', x.intersp = 0.2, y.intersp = 0.15, inset = c(-0.5, -0.3), seg.len = 0.7)
# plot 3
